...
<body>
    <form action="php/auth.php" method="POST">
        ...
        <button type="submit">Crear cuenta<a href="../index/index.html"></a></button>
        <p class="registro" style="width: fit-content; align-self: center;">¿Ya tienes una cuenta? <a
                href="../login/login.html.php">Inicia sesión aquí</a></p>
    </form>
